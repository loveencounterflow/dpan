(function() {
  'use strict';
  var CND, Dba, E, FS, PATH, SQL, badge, createRequire, debug, def, echo, freeze, glob, got, help, info, isa, isa_list_of, isa_optional, lets, misfit, rpr, semver_cmp, semver_satisfies, type_of, types, urge, validate, validate_list_of, warn, whisper;
  ...
  //-----------------------------------------------------------------------------------------------------------
  types.declare('dpan_db_add_pkg_info_cfg', {
    tests: {
      '@isa.object x': function(x) {
        return this.isa.object(x);
      },
      '@isa.dpan_pkg_info x.pkg_info': function(x) {
        return this.isa.dpan_pkg_info(x.pkg_info);
      }
    }
  });
