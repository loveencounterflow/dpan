(function() {
  'use strict';
  var CND, Dba, E, FS, PATH, SQL, badge, debug, def, echo, freeze, glob, got, help, info, isa, lets, misfit, rpr, semver_cmp, semver_satisfies, type_of, types, urge, validate, validate_list_of, warn, whisper;
...
drop table if exists ${prefix}pkg_versions;`);
  ...
  on conflict do nothing;`
    ...
    async fs_fetch_pkg_json_info(cfg) {
      var RPKGUP, pkg_description, pkg_json, pkg_json_fspath, pkg_json_info, pkg_keywords, pkg_version, ref;
      ...
      return {pkg_json, pkg_version, pkg_description, pkg_keywords, pkg_json_fspath};
    }
