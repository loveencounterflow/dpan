(function() {
  'use strict';
  var CND, Dba, Dbv, Dtags, E, FS, PATH, SQL, badge, createRequire, debug, echo, freeze, glob, got, guy, help, info, isa, isa_list_of, isa_optional, lets, misfit, rpr, semver_cmp, semver_satisfies, type_of, types, urge, validate, validate_list_of, warn, whisper;
  ...
  this.Dpan = class Dpan {
    ...
    constructor(cfg) {
      ...
      this./* create table `dpan_variables` */tags = new Dtags({
        dba: this.dba,
        prefix: this.cfg.prefix
      });
      //.......................................................................................................
      ...
      /* create tagging tables */      guy.props.def(this, '_cache', {
        enumerable: false,
        value: {}
      });
