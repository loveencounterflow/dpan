(function() {
  'use strict';
  var CND, Dba, Dbv, Dtags, E, FS, PATH, SQL, badge, createRequire, debug, def, echo, freeze, glob, got, help, info, isa, isa_list_of, isa_optional, lets, misfit, rpr, semver_cmp, semver_satisfies, type_of, types, urge, validate, validate_list_of, warn, whisper;
  ...
  this.Dpan = class Dpan {
    ...
    constructor(cfg) {
      ...
      /* create tagging tables */      def(this, '_cache', {
        enumerable: false,
        value: {}
      });
